...
const Projects = ({ isDarkMode }) => {
  const commercialProjects = [
    ...
    {
      title: "Лендинг для коммерческой недвижимости",
      description:
        "Лендинг для коммерческой недвижимости, который помогает клиентам сдать или арендовать недвижимость в городе Петропавловск-Камчатский.",
